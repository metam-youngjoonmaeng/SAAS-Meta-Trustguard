            ...
            <div className="bg-white p-6 rounded-xl border border-[var(--border)] shadow-sm mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1.5 min-w-0">
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] gap-2 items-center min-w-0">
                            <input
                                type="date"
                                lang="en-CA"
                                className="w-full min-w-0 px-3 py-2 bg-[var(--background-soft)] border border-[var(--border-strong)] rounded-lg text-sm focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all"
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-[var(--ink-500)] uppercase tracking-wider">상담번호</label>
                        <div className="relative" title="입력 시 기간·부서 등 다른 필터를 무시하고 전체에서 바로 조회합니다">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                            <input
                                type="text"
                                placeholder="상담번호 직접 조회"
                                className="w-full pl-10 pr-4 py-2 bg-[var(--background-soft)] border border-[var(--border-strong)] rounded-lg text-sm focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all placeholder:text-gray-400"
                        ...
                        <table className="w-full border-collapse table-fixed text-left">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th rowSpan={2} className="sticky top-0 z-20 bg-[var(--background-soft)] border-b border-[var(--border)] px-3 py-2 text-[12px] font-semibold text-[var(--ink-500)]">상담사명</th>
                                    <th rowSpan={2} className="sticky top-0 z-20 bg-[var(--background-soft)] border-b border-[var(--border)] px-3 py-2 text-[12px] font-semibold text-[var(--ink-500)]">부서</th>
                            ...
                            <tbody className="divide-y divide-[var(--muted)]">
                                {isLoading ? (
                                    <tr>
                                        <td colSpan={9 + CHECKLIST_KEYS.length} className="py-20 text-center text-[var(--ink-400)] text-[13px]">
                                            데이터를 불러오는 중입니다...
                                        </td>
                                    </tr>
                                ) : filteredCalls.length === 0 ? (
                                    ...
                                    return (
                                        <tr key={row.qa_id} className="hover:bg-[var(--background-soft)] transition-colors group">
                                            ...
                                            <td className="px-3 py-3 text-[13px] text-[var(--ink-700)]">{row.department || '-'}</td>
