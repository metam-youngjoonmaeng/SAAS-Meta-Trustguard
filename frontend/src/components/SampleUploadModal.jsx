...
import { startQaPipelineJob, fetchQaPipelineJob, currentOrgId, fetchOrganizations } from '../services/api';
...
export default function SampleUploadModal({ onUploaded }) {
    ...
    // 모달 열릴 때 브랜드 이름 맵 로드 — "활성 브랜드(코오롱)로 적재" 안내용 (실패 시 org_id 숫자로 폴백)
    useEffect(() => {
